...
public class FlowsModule : IDependencyModule
{
    public void Setup(IServiceCollection services)
    {
        ...
        // Cloners
        services.AddSingleton<IFlowCloner, FlowCloner>();
        services.AddSingleton<IFlowTriggerCloner, FlowTriggerCloner>();
        services.AddSingleton<IFlowTaskCloner, FlowTaskCloner>();
    }
}